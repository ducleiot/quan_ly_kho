...
class PeerAssessment {
    ...
    public static function CalcPeerAssessmentMark ($exam_class_id) {
        ...
        if($exam_class!=null){
            ...
            $assessment_quantity = $exam_class->assessment_quantity;
        }else{
            $percent_1 = 0.6;
            $percent_2 = 0.2;
            $percent_3 = 0.2;
        ...
        foreach ($students as $key => $value) {
            ...
            $mark_all_student = PeerAssessment::getStudentMark($exam_class_id, $value->id, $assessment_quantity);
            $mark_peer_assessment = PeerAssessment::getAllStudentMarkOfExam($exam_class_id, $value->id, $mark_all_teachers, $mark_max, $assessment_quantity);
            ...
            $mark_info[] = array(
                ...
                "mark_1"          => round($mark_1,1),
                "mark_2"          => round($mark_2,1),
                "mark_3"          => round($mark_3,1),
    ...
    // calc the mark 3
    public static function getAllStudentMarkOfExam($exam_class_id, $student_id, $teacher_mark, $mark_max, $qty){
        $res = array();
    ...
    // calc mark 2    
    public static function getStudentMark($exam_class_id, $student_id, $qty){
        $res = array();
        $query = DB::table("mark_student")
