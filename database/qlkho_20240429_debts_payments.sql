...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 29, 2024 lúc 05:48 AM
...
CREATE TABLE `customers` (
  ...
  `bank` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `description` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL,
...
(72, 1, 'admin@gmail.com', '2024-04-08 21:26:36', NULL),
(73, 1, 'admin@gmail.com', '2024-04-08 21:56:29', NULL),
(74, 1, 'admin@gmail.com', '2024-04-08 22:01:13', NULL),
(75, 1, 'admin@gmail.com', '2024-04-09 20:54:48', NULL);
...
CREATE TABLE `products` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `unit` varchar(255) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by` bigint(20) UNSIGNED NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL
...
--
-- Cấu trúc bảng cho bảng `product_quantities`
--
...
--
-- Đang đổ dữ liệu cho bảng `product_quantities`
--
...
CREATE TABLE `sales` (
  ...
  `employee_name` varchar(255) COLLATE utf8_vietnamese_ci NOT NULL,
  `date` date NOT NULL,
...
INSERT INTO `sales` (`id`, `customer_id`, `employee_id`, `customer_name`, `employee_name`, `date`, `note`, `pay_status`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(12, 1, 13, 'Nguyễn Thị Dung', 'Đoàn Viết Dũng', '2024-04-09', NULL, 0, '2024-04-09', 1, NULL, NULL),
(13, 1, 13, 'Nguyễn Thị Dung', 'Đoàn Viết Dũng', '2024-04-29', NULL, 0, '2024-04-29', 1, NULL, NULL);
...
CREATE TABLE `sale_details` (
  ...
  `package_name` varchar(255) COLLATE utf8_vietnamese_ci NOT NULL,
  `color_name` varchar(255) COLLATE utf8_vietnamese_ci NOT NULL,
  `quantity` double NOT NULL DEFAULT 0,
  `unit` varchar(255) COLLATE utf8_vietnamese_ci NOT NULL DEFAULT 'Kg',
...
INSERT INTO `sale_details` (`id`, `sale_id`, `product_id`, `package_id`, `color_id`, `product_name`, `package_name`, `color_name`, `quantity`, `unit`, `price`, `total`, `note`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(3, 12, 2, 3, 1, 'Bắp Hột', 'Bao 50 Kg', 'Màu Trắng', 2700, 'Kg', '8800.0000', '23760000.0000', NULL, '2024-04-09', 1, NULL, NULL),
(4, 12, 4, 3, 8, 'Nếp Mía', 'Bao 50 Kg', 'Màu Vàng', 3000, 'Kg', '22000.0000', '66000000.0000', NULL, '2024-04-09', 1, NULL, NULL),
(5, 13, 1, 1, 3, 'Bắp Xay Mịn', 'Bao 10 Kg', 'Màu Hồng', 10, 'Kg', '100.0000', '1000.0000', NULL, '2024-04-29', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `sale_pays`
--
...
--
-- Chỉ mục cho bảng `product_quantities`
--
...
--
-- AUTO_INCREMENT cho bảng `product_quantities`
--
ALTER TABLE `product_quantities`
...
--
-- AUTO_INCREMENT cho bảng `sale_pays`
--
ALTER TABLE `sale_pays`
