        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="container dc-question-container">
                    <ul class="nav dc-nav-tabs nav-tabs" role="tablist">
                        <li class="nav-item dc-nav-item waves-effect waves-light">
                            <a class="nav-link dc-nav-link active" data-toggle="tab" role="tab"><font style="color:#1827f8">GV {{$item->last_name . " " . $item->first_name}}:</font> {{ $item->mark . "(đ)" }}</a>
                        </li>
                    </ul>
                ...
                <div class="container dc-question-container">
                    <ul class="nav dc-nav-tabs nav-tabs" role="tablist">
                        <li class="nav-item dc-nav-item waves-effect waves-light">
                            <a class="nav-link dc-nav-link active" data-toggle="tab" role="tab"><font style="color:#1827f8">HS#{{$step}}:</font> {{ $item->mark . "(đ)" }}</a>
                        </li>
                    </ul>
                    <div class="tab-content dc-tab-content">
                        <div class="tab-pane active" role="tabpanel">
