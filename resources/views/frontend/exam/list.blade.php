                ...
                formatters: {
                    "commands": function(column, row) {
                        switch (parseInt(row.status)) {
                            ...
                            break;
                            case 3 :
                                return "<button type=\"button\" class=\"btn bootgrid-btn-outline btn-sm btn-outline-success btn-view-answer\" data-row-id=\"" +
                                    row.id + "\" data-exam-id=\"" + row.exam_id + "\" data-exam-title=\"" +
                                    row.exam_title + "\"> Xem Bài Làm </button> <br/>" +
                                "<button type=\"button\" class=\"btn bootgrid-btn-outline btn-sm btn-outline-success btn-assess-exam\" data-row-id=\"" +
                                    row.id + "\" data-exam-id=\"" + row.exam_id + "\" data-exam-title=\"" +
