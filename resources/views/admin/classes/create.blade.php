                    ...
                    <form method="POST" action="{{ url('admin/ql-lop-hoc/luu-moi') }}" enctype="multipart/form-data">
                      ...
                      {{--   <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Lớp Học"
                            maxlength="255" required placeholder="Lớp Học" value="@php echo Session::has('data')? Session::get('data')['name'] : ''; @endphp" />
                        </div>
                        <div class="form-group">
