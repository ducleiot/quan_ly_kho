            ...
            "commands": function(column, row) {
                 <?php if(auth()->user()->level == 0){ ?>
                    ...
                    <?php }else{ ?>
                        ...
                        return "<button title='Xem Danh Sách Học Sinh' type=\"button\" class=\"btn btn-sm bootgrid-btn-outline btn-outline-primary command-view\" data-row-id=\"" +
                        row.id + "\" data-row-title=\"" +
                        row.name + "\"><span class=\"color:#028e11;\"></span>DS Học Sinh</button> " ;
...
.bootgrid-table > tbody > tr > td > button.command-view:hover{
    color:#fff !important;
}
</style>
@endsection
